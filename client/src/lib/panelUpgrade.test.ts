...
test("builds a direct changelog URL unless panel update acceleration is fully enabled", () => {
  const directUrl = "https://github.com/ludehonghaha/Forwardx/releases/tag/v2.3.275";
...
test("accelerates generated and supplied GitHub release URLs", () => {
  const releaseUrl = "https://github.com/ludehonghaha/Forwardx/releases/tag/v2.3.275";
