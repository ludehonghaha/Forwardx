...
export const BUILTIN_PLUGIN_STORE_ITEMS: PluginStoreItem[] = [
  {
    ...
    repository: "https://github.com/ludehonghaha/Forwardx",
    branch: "main",
    manifestPath: "plugins/china-region-whitelist/forwardx-plugin.json",
    homepage: "https://github.com/ludehonghaha/Forwardx",
    author: "poouo",
    packageRepository: "https://github.com/ludehonghaha/Forwardx",
    packageBranch: "main",
