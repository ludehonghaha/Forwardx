...
const tables: TableDef[] = [
  ...
  { name: "host_probe_services", columns: [c("id", "id"), c("name", "text", { notNull: true }), c("method", "varchar", { length: 16, notNull: true, default: "tcping" }), c("targetIp", "text", { notNull: true }), c("targetPort", "int"), c("probeKind", "varchar", { length: 32, notNull: true, default: "custom" }), c("carrier", "varchar", { length: 8 }), c("region", "text"), c("hostScope", "varchar", { length: 16, notNull: true, default: "all" }), c("hostIds", "text"), c("excludeHostIds", "text"), c("intervalSeconds", "int", { notNull: true, default: 30 }), c("isEnabled", "bool", { notNull: true, default: true }), c("sortOrder", "int", { notNull: true, default: 0 }), c("userId", "int", { notNull: true }), c("createdAt", "epoch", { notNull: true, default: "now" }), c("updatedAt", "epoch", { notNull: true, default: "now" })], indexes: [["userId", "sortOrder"], ["userId", "createdAt"], ["isEnabled"], ["hostScope"], ["probeKind", "carrier"], ["carrier", "region"]] },
  { name: "host_probe_service_stats", columns: [c("id", "id"), c("serviceId", "int", { notNull: true }), c("hostId", "int", { notNull: true }), c("latencyMs", "int"), c("isTimeout", "bool", { notNull: true, default: false }), c("successCount", "int"), c("lossCount", "int"), c("packetLossPermille", "int"), c("recordedAt", "epoch", { notNull: true, default: "now" })], indexes: [["serviceId", "recordedAt"], ["hostId", "recordedAt"], ["recordedAt", "serviceId"], ["serviceId", "hostId", "recordedAt"]] },
  { name: "host_network_quality_stats", columns: [c("id", "id"), c("hostId", "int", { notNull: true }), c("latencyMs", "int"), c("successCount", "int", { notNull: true }), c("lossCount", "int", { notNull: true }), c("packetLossPermille", "int", { notNull: true }), c("recordedAt", "epoch", { notNull: true, default: "now" })], indexes: [["hostId", "recordedAt"], ["recordedAt", "hostId"]] },
